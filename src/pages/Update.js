                                ...
                                <div className="row gutters">
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="fullName"
                                                   placeholder="Enter full name" value={name} name="name" onChange={e => set_name(e.target.value)}/>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="phone" onChange={e => set_username(e.target.value)}
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            ...
                                            <input type="password" className="form-control" id="website" onChange={e => set_password(e.target.value)}
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            ...
                                            <input type="name" className="form-control" id="Street" placeholder="apikey"
                                                   onChange={e => set_apikey(e.target.value)} name="api_key" value={apikey}/>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            <label htmlFor="ciTy">Secret key</label>
                                            <input type="name" className="form-control" id="ciTy" onChange={e => set_secret(e.target.value)}
                                ...
                                <div className="row gutters mt-3">
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div className="text-right">
                                            <button type="button" name="submit" className="btn btn-secondary" onClick={e => navigate('/')}>Cancel
                                            </button>
